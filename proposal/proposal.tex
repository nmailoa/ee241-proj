...
\title{Interleaved SRAM Read Stability Assist Techniques}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Bhavana Chaurasia}
\IEEEauthorblockA{\emph{M.Eng., 2015}\\
Department of Electrical Engineering\\and Computer Science\\
University of California, Berkeley\\
\emph{bhavanac@berkeley.edu}}
\and
\IEEEauthorblockN{Nathaniel Anthony Mailoa}
\IEEEauthorblockA{\emph{B.S., 2015 / M.S., 2016}\\
Department of Electrical Engineering\\and Computer Science\\
University of California, Berkeley\\
\emph{nmailoa@berkeley.edu}}
\and
\IEEEauthorblockN{Yoonhwan Kang}
\IEEEauthorblockA{\emph{M.S./Ph.D., 2018}\\
Department of Electrical Engineering\\and Computer Science\\
University of California, Berkeley\\
\emph{kang.yoonhwan@berkeley.edu}}
}
...
\bibitem{Zimmer}
B.~Zimmer, S.~O.~Toh, H.~Vo, Y.~Lee, O.~Thomas, K.~Asanovi\'{c}, and B.~Nikoli\'{c}, "SRAM Assist Techniques for Operation in a Wide Voltage Range in 28-nm CMOS," \emph{IEEE Transactions on Circuits and Systems}, vol. 59, no. 12, pp.853-857, Dec. 2012.

\end{thebibliography}

\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{4WL_cell_box_level.png}
\includegraphics[width=2in]{4WL_cell.png}
\caption{Multiple word line per row}
\label{fig1}
\end{figure}

\begin{figure}[!t]
\centering
\includegraphics[width=2.1in]{fig1}
\caption{Column-controlled word line}
\label{fig1}
\end{figure}

\begin{figure}[!t]
\centering
\includegraphics[width=2.1in]{fig2}
\caption{Word-line-controlled PG}
\label{fig2}
\end{figure}
